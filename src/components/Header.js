            ...
            <nav style={menuHeaderColor} className="navbar navbar-inverse navbar-fixed-top">
                <div className="container-fluid menu-header">
                    <div className="navbar-header">
                        ...
                        <img style={iconPosition} className="text-left margin-5" src={ white_ipay_logo } alt="ipay" width="110" height="50"/>
                        <a style={headerFontColor} className="navbar-brand" href="https://www.ipay.com.bd">iPay Bizz Tool</a>
                    </div>
